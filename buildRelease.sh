...
#./buildRelease.sh -apiKey=LSAqh3V.9AttjtiGQAWCsX97S0WEyjgtibTrSamArce -serverBase=http://localhost:8088/semarchy -modelname=DemoTest -devModelEdition=0.1 -o=Models -r='This is test. Building release for DemoTest [0.1]'
